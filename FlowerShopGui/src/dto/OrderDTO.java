...
public class OrderDTO {
	...
	public OrderDTO(int orderNumber, String orderDate, String firstName, String lastName, String phoneNumber,
			String email, String flowerType, int flowerQty, String accessoryType, String arrangementTheme,
			String address, String deliveryDate, double totalCost, String hasCard, String cardText, String isPaidFor,
			String isDelivered) {
